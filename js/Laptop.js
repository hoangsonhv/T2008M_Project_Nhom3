...
function gridProductShop_Laptop() {
    var g_html = "";
...
function loadData() {
    ...
    xhttp.onreadystatechange = function () {
        if(this.readyState == 4 && this.status == 200){
            ...
            var grid = document.getElementById("Laptop_Bags");
            grid.innerHTML = gridProductShop_Laptop();
        }
    }
    xhttp.open("GET","https://sonhoang.herokuapp.com/laptop");
    xhttp.send();
}
loadData();