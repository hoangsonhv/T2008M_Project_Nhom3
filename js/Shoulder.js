...
function gridProductShop_Shoulder() {
    var g_html = "";
...
function loadData() {
    ...
    xhttp.onreadystatechange = function () {
        if(this.readyState == 4 && this.status == 200){
            ...
            var grid = document.getElementById("Shoulder_Bags");
            grid.innerHTML = gridProductShop_Shoulder();
        }
    }
    xhttp.open("GET","https://sonhoang.herokuapp.com/shoulder");
    xhttp.send();
}
loadData();