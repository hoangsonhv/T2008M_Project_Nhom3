...
function gridProductBestsellers() {
    var g_html = "";
    for (var i=1;i<9;i++){
        g_html += "<div class=\"col-md-3\">\n" +
            "           <div class=\"product\">\n" +
            "               <div class=\"item\">\n" +
            "                   <a href='Bestsellers.html?Id="+ products[i].Id +"'><img class=\"image\" src=\""+products[i].Image +"\" alt=\"\"></a>\n" +
...
function loadData() {
    ...
    xhttp.onreadystatechange = function () {
        if(this.readyState == 4 && this.status == 200){
            ...
            var grid = document.getElementById("Best_Sellers");
            grid.innerHTML = gridProductBestsellers();
        }
    }
