...
function loadData() {
    ...
    xhttp.onreadystatechange = function () {
        if(this.readyState == 4 && this.status == 200){
            ...
            var grid = document.getElementById("Marc_Jacobs");
            grid.innerHTML = gridProductShop_Marc();
        }
    }
    xhttp.open("GET","https://sonhoang.herokuapp.com/Marc");
    xhttp.send();
}
loadData();