...
function loadData() {
    ...
    xhttp.onreadystatechange = function () {
        if(this.readyState == 4 && this.status == 200){
            ...
            var grid = document.getElementById("Hand_Bags");
            grid.innerHTML = gridProductShop_Hand();
        }
    }
    xhttp.open("GET","https://sonhoang.herokuapp.com/hand");
    xhttp.send();
}
loadData();