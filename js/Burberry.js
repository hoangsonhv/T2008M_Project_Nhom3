...
function gridProductShop_Burberry() {
    var g_html = "";
...
function loadData() {
    ...
    xhttp.onreadystatechange = function () {
        if(this.readyState == 4 && this.status == 200){
            ...
            var grid = document.getElementById("Burberry");
            grid.innerHTML = gridProductShop_Burberry();
        }
    }
    xhttp.open("GET","https://sonhoang.herokuapp.com/Burberry");
    xhttp.send();
}
loadData();