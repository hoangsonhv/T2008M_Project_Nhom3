...
function gridProductShop_Louis() {
    var g_html = "";
...
function loadData() {
    ...
    xhttp.onreadystatechange = function () {
        if(this.readyState == 4 && this.status == 200){
            ...
            var grid = document.getElementById("Louis_Vuitton");
            grid.innerHTML = gridProductShop_Louis();
        }
    }
    xhttp.open("GET","https://sonhoang.herokuapp.com/Louis");
    xhttp.send();
}
loadData();