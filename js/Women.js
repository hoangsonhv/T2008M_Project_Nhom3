...
function gridProductShop_women() {
    var g_html = "";
...
function loadData() {
    ...
    xhttp.onreadystatechange = function () {
        if(this.readyState == 4 && this.status == 200){
            ...
            var grid = document.getElementById("Women");
            grid.innerHTML = gridProductShop_women();
        }
    }
    xhttp.open("GET","https://sonhoang.herokuapp.com/women");
    xhttp.send();
}
loadData();