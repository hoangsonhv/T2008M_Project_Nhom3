...
function gridProductShop_Chanel() {
    var g_html = "";
...
function loadData() {
    ...
    xhttp.onreadystatechange = function () {
        if(this.readyState == 4 && this.status == 200){
            ...
            var grid = document.getElementById("Chanel");
            grid.innerHTML = gridProductShop_Chanel();
        }
    }
    xhttp.open("GET","https://sonhoang.herokuapp.com/Chanel");
    xhttp.send();
}
loadData();