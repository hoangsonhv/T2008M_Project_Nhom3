...
function gridProductShop_Purse() {
    var g_html = "";
...
function loadData() {
    ...
    xhttp.onreadystatechange = function () {
        if(this.readyState == 4 && this.status == 200){
            ...
            var grid = document.getElementById("Purse");
            grid.innerHTML = gridProductShop_Purse();
        }
    }
    xhttp.open("GET","https://sonhoang.herokuapp.com/purse");
    xhttp.send();
}
loadData();