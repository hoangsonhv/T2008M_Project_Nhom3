...
function gridProductShop_Wallet() {
    var g_html = "";
...
function loadData() {
    ...
    xhttp.onreadystatechange = function () {
        if(this.readyState == 4 && this.status == 200){
            ...
            var grid = document.getElementById("Wallet");
            grid.innerHTML = gridProductShop_Wallet();
        }
    }
    xhttp.open("GET","https://sonhoang.herokuapp.com/wallet");
    xhttp.send();
}
loadData();